...
def evaluate_c(model: Module, dataloader: DataLoader, prepare_batch: Callable, metrics: List[Union[str, Callable]],
            n_shot:str, k_way:int, q_queries:int, optimiser: Optimizer, loss_fn: Callable = None, prefix: str = 'val_', suffix: str = ''):
    ...
    with torch.no_grad():
        for batch in dataloader:
            ...
            loss, y_pred = proto_net_episode(model, optimiser, loss_fn, x, y, n_shot, k_way, q_queries, distance ='l2', train=False)
